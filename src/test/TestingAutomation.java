...
public class TestingAutomation {
	public static void test() {
		//images for testing
		String[] images = new String[] {"test_noise.jpg"};
		...
		for(String image : images) {
			...
			for(int i = 440; i > 0; i-=5) {
				...
				Mat result = RegionGrowing.regionGrowing2(source, i);
				time =System.currentTimeMillis()- time; 
				int regions = RegionGrowing.regions;
				String imageName = "threshold_" + i + "_time_" + time +"_regions_" + regions + ".jpg";
				Imgcodecs.imwrite("C:/Users/matteo/MultimediaSystemProject/output/denoise_on/regionGrowing2/" + image.replace(".", "_") + "/" + imageName, result);
